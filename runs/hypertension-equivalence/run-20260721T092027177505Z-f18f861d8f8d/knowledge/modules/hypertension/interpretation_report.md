...
Generated at: `2026-07-21T09:20:37.606700+00:00`
...
| --- | --- |
| Module | hypertension |
| Pipeline run | run-20260721T092027177505Z-f18f861d8f8d |
| Overall status | FAIL |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| structural | WARNING | low | 3 | 7 | 0 | 0 | yes |
| statistical | FAIL | high | 4 | 37 | 0 | 27 | no |
| clinical | FAIL | high | 3 | 12 | 0 | 4 | no |
| epidemiological | INCONCLUSIVE | high | 3 | 2 | 1 | 1 | no |
| spanish_adaptation | INCONCLUSIVE | info | 5 | 0 | 5 | 0 | no |

## Priority Findings

### Clinical code concordance for 'observations' is fail

| Field | Value |
| --- | --- |
| Finding ID | CLINICAL.CODE_OVERLAP.observations.FAIL |
...
**Observation.** Jaccard=0.250, overlap=0.400, JSD=0.974, shared=2, Synthea-only=3, psynthea-only=3.

**Interpretation.** The candidate shows materially poor clinical code-set or frequency concordance.

**Impact.** Clinically represented concepts or their relative frequencies may be materially different.
...
| hypertension.functional.distributional_similarity.observations.jaccard_similarity | primary | available | 0.25 | — |
| hypertension.functional.distributional_similarity.observations.jensen_shannon_divergence | primary | available | 0.973620647114106 | — |
| hypertension.functional.distributional_similarity.observations.overlap_coefficient | primary | available | 0.4 | — |
| hypertension.functional.distributional_similarity.observations.psynthea_only_code_count | primary | available | 3 | — |
| hypertension.functional.distributional_similarity.observations.psynthea_total | primary | available | 3465 | — |
| hypertension.functional.distributional_similarity.observations.shared_code_count | primary | available | 2 | — |
| hypertension.functional.distributional_similarity.observations.synthea_only_code_count | primary | available | 3 | — |
| hypertension.functional.distributional_similarity.observations.synthea_total | primary | available | 3227 | — |
| hypertension.functional.distributional_similarity.observations.valid_for_distributional_comparison | primary | available | True | — |
...
### Distribution endpoint 'observations.chi_square': fail

| Field | Value |
| --- | --- |
| Finding ID | STAT.DISTRIBUTION.observations.chi_square.FAIL |
...
**Observation.** distribution test: p=0, JSD=0.190315, effect_size=0.9837613357144366, n_synthea=3227, n_psynthea=3465.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.distribution.observations.chi_square.effect_size | primary | available | 0.9837613357144366 | — |
| hypertension.statistics.distribution.observations.chi_square.jensen_shannon_divergence | primary | available | 0.1903145673204594 | — |
| hypertension.statistics.distribution.observations.chi_square.n_psynthea | primary | available | 3465.0 | — |
| hypertension.statistics.distribution.observations.chi_square.n_synthea | primary | available | 3227.0 | — |
| hypertension.statistics.distribution.observations.chi_square.notes | primary | not_computed | — | — |
| hypertension.statistics.distribution.observations.chi_square.p_value | primary | available | 0.0 | — |
| hypertension.statistics.distribution.observations.chi_square.significant | primary | available | True | — |
| hypertension.statistics.distribution.observations.chi_square.statistic | primary | available | 6476.426358907398 | — |
...
**Observation.** Synthea prevalence=0.29; psynthea prevalence=0.48; absolute_difference=0.19; relative_difference=0.6551724137931035; risk_ratio=1.6551724137931034; 95% CI=[1.1451978948420525, 2.3922465555698027]; adjusted_p=0.0057619882530573; significant_after_fdr=True.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.prevalence.conditions.59621000.absolute_difference | primary | available | 0.19 | — |
| hypertension.statistics.prevalence.conditions.59621000.adjusted_p_value | primary | available | 0.0057619882530573 | — |
| hypertension.statistics.prevalence.conditions.59621000.notes | primary | not_computed | — | — |
| hypertension.statistics.prevalence.conditions.59621000.odds_ratio | primary | available | 2.259946949602122 | — |
| hypertension.statistics.prevalence.conditions.59621000.odds_ratio_ci_lower | primary | available | 1.260918032579892 | — |
| hypertension.statistics.prevalence.conditions.59621000.odds_ratio_ci_upper | primary | available | 4.050509298027929 | — |
| hypertension.statistics.prevalence.conditions.59621000.p_value | primary | available | 0.0057619882530573 | — |
| hypertension.statistics.prevalence.conditions.59621000.psynthea_events | primary | available | 48 | — |
| hypertension.statistics.prevalence.conditions.59621000.psynthea_prevalence | primary | available | 0.48 | — |
| hypertension.statistics.prevalence.conditions.59621000.psynthea_total | primary | available | 100 | — |
| hypertension.statistics.prevalence.conditions.59621000.relative_difference | primary | available | 0.6551724137931035 | — |
| hypertension.statistics.prevalence.conditions.59621000.risk_ratio | primary | available | 1.6551724137931034 | — |
| hypertension.statistics.prevalence.conditions.59621000.risk_ratio_ci_lower | primary | available | 1.1451978948420525 | — |
| hypertension.statistics.prevalence.conditions.59621000.risk_ratio_ci_upper | primary | available | 2.3922465555698027 | — |
...
| hypertension.statistics.prevalence.conditions.59621000.statistic | primary | available | 2.7610271708016896 | — |
...
| … 1 more | — | — | — | — |
### Prevalence endpoint 'observations.29463-7': fail

| Field | Value |
| --- | --- |
| Finding ID | STAT.PREVALENCE.observations.29463-7.FAIL |
| Rule | STAT.PREVALENCE |
| Status | FAIL |
| Severity | high |
| Confidence | high |
...
**Observation.** Synthea prevalence=0; psynthea prevalence=0.97; absolute_difference=0.97; relative_difference=None; risk_ratio=None; 95% CI=[12.278906534684427, 3096.77412175019]; adjusted_p=1.4575867941749593e-42; significant_after_fdr=True.
...
- FDR controls the expected false-discovery proportion across tested prevalence endpoints.
- Statistical prevalence similarity does not establish clinical pathway equivalence.
- A complete risk-ratio confidence interval was unavailable; the decision relies on absolute and relative prevalence margins.

**Evidence**
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.prevalence.observations.29463-7.absolute_difference | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.29463-7.adjusted_p_value | primary | available | 1.4575867941749593e-42 | — |
| hypertension.statistics.prevalence.observations.29463-7.notes | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.29463-7.odds_ratio | primary | available | 5599.285714285715 | — |
| hypertension.statistics.prevalence.observations.29463-7.odds_ratio_ci_lower | primary | available | 285.47036429855126 | — |
| hypertension.statistics.prevalence.observations.29463-7.odds_ratio_ci_upper | primary | available | 109825.7627801094 | — |
| hypertension.statistics.prevalence.observations.29463-7.p_value | primary | available | 7.287933970874797e-43 | — |
| hypertension.statistics.prevalence.observations.29463-7.psynthea_events | primary | available | 97 | — |
| hypertension.statistics.prevalence.observations.29463-7.psynthea_prevalence | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.29463-7.psynthea_total | primary | available | 100 | — |
| hypertension.statistics.prevalence.observations.29463-7.relative_difference | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.29463-7.risk_ratio | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.29463-7.risk_ratio_ci_lower | primary | available | 12.278906534684427 | — |
| hypertension.statistics.prevalence.observations.29463-7.risk_ratio_ci_upper | primary | available | 3096.77412175019 | — |
| hypertension.statistics.prevalence.observations.29463-7.significant | primary | available | True | — |
| hypertension.statistics.prevalence.observations.29463-7.significant_after_fdr | primary | available | True | — |
| hypertension.statistics.prevalence.observations.29463-7.statistic | primary | available | 13.72404876714983 | — |
| hypertension.statistics.prevalence.observations.29463-7.synthea_events | primary | available | 0 | — |
| hypertension.statistics.prevalence.observations.29463-7.synthea_prevalence | primary | available | 0.0 | — |
| hypertension.statistics.prevalence.observations.29463-7.synthea_total | primary | available | 100 | — |
| … 1 more | — | — | — | — |
### Prevalence endpoint 'observations.39156-5': fail

| Field | Value |
| --- | --- |
| Finding ID | STAT.PREVALENCE.observations.39156-5.FAIL |
| Rule | STAT.PREVALENCE |
| Status | FAIL |
| Severity | high |
| Confidence | high |
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.prevalence.observations.39156-5.absolute_difference | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.39156-5.adjusted_p_value | primary | available | 1.4575867941749593e-42 | — |
| hypertension.statistics.prevalence.observations.39156-5.notes | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.39156-5.odds_ratio | primary | available | 5599.285714285715 | — |
| hypertension.statistics.prevalence.observations.39156-5.odds_ratio_ci_lower | primary | available | 285.47036429855126 | — |
| hypertension.statistics.prevalence.observations.39156-5.odds_ratio_ci_upper | primary | available | 109825.7627801094 | — |
| hypertension.statistics.prevalence.observations.39156-5.p_value | primary | available | 7.287933970874797e-43 | — |
| hypertension.statistics.prevalence.observations.39156-5.psynthea_events | primary | available | 97 | — |
| hypertension.statistics.prevalence.observations.39156-5.psynthea_prevalence | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.39156-5.psynthea_total | primary | available | 100 | — |
| hypertension.statistics.prevalence.observations.39156-5.relative_difference | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.39156-5.risk_ratio | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.39156-5.risk_ratio_ci_lower | primary | available | 12.278906534684427 | — |
| hypertension.statistics.prevalence.observations.39156-5.risk_ratio_ci_upper | primary | available | 3096.77412175019 | — |
| hypertension.statistics.prevalence.observations.39156-5.significant | primary | available | True | — |
| hypertension.statistics.prevalence.observations.39156-5.significant_after_fdr | primary | available | True | — |
| hypertension.statistics.prevalence.observations.39156-5.statistic | primary | available | 13.72404876714983 | — |
| hypertension.statistics.prevalence.observations.39156-5.synthea_events | primary | available | 0 | — |
| hypertension.statistics.prevalence.observations.39156-5.synthea_prevalence | primary | available | 0.0 | — |
| hypertension.statistics.prevalence.observations.39156-5.synthea_total | primary | available | 100 | — |
| … 1 more | — | — | — | — |
### Prevalence endpoint 'observations.8302-2': fail

| Field | Value |
| --- | --- |
| Finding ID | STAT.PREVALENCE.observations.8302-2.FAIL |
| Rule | STAT.PREVALENCE |
| Status | FAIL |
| Severity | high |
| Confidence | high |
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.prevalence.observations.8302-2.absolute_difference | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.8302-2.adjusted_p_value | primary | available | 1.4575867941749593e-42 | — |
| hypertension.statistics.prevalence.observations.8302-2.notes | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.8302-2.odds_ratio | primary | available | 5599.285714285715 | — |
| hypertension.statistics.prevalence.observations.8302-2.odds_ratio_ci_lower | primary | available | 285.47036429855126 | — |
| hypertension.statistics.prevalence.observations.8302-2.odds_ratio_ci_upper | primary | available | 109825.7627801094 | — |
| hypertension.statistics.prevalence.observations.8302-2.p_value | primary | available | 7.287933970874797e-43 | — |
| hypertension.statistics.prevalence.observations.8302-2.psynthea_events | primary | available | 97 | — |
| hypertension.statistics.prevalence.observations.8302-2.psynthea_prevalence | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.8302-2.psynthea_total | primary | available | 100 | — |
| hypertension.statistics.prevalence.observations.8302-2.relative_difference | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.8302-2.risk_ratio | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.8302-2.risk_ratio_ci_lower | primary | available | 12.278906534684427 | — |
| hypertension.statistics.prevalence.observations.8302-2.risk_ratio_ci_upper | primary | available | 3096.77412175019 | — |
| hypertension.statistics.prevalence.observations.8302-2.significant | primary | available | True | — |
| hypertension.statistics.prevalence.observations.8302-2.significant_after_fdr | primary | available | True | — |
| hypertension.statistics.prevalence.observations.8302-2.statistic | primary | available | 13.72404876714983 | — |
| hypertension.statistics.prevalence.observations.8302-2.synthea_events | primary | available | 0 | — |
| hypertension.statistics.prevalence.observations.8302-2.synthea_prevalence | primary | available | 0.0 | — |
| hypertension.statistics.prevalence.observations.8302-2.synthea_total | primary | available | 100 | — |
| … 1 more | — | — | — | — |
### Prevalence endpoint 'observations.8462-4': fail

| Field | Value |
| --- | --- |
| Finding ID | STAT.PREVALENCE.observations.8462-4.FAIL |
| Rule | STAT.PREVALENCE |
| Status | FAIL |
| Severity | high |
| Confidence | high |
...
**Observation.** Synthea prevalence=0.11; psynthea prevalence=0.97; absolute_difference=0.86; relative_difference=7.818181818181818; risk_ratio=8.818181818181818; 95% CI=[5.04424894012989, 15.4156409609138]; adjusted_p=4.586054242234715e-34; significant_after_fdr=True.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.prevalence.observations.8462-4.absolute_difference | primary | available | 0.86 | — |
| hypertension.statistics.prevalence.observations.8462-4.adjusted_p_value | primary | available | 4.586054242234715e-34 | — |
| hypertension.statistics.prevalence.observations.8462-4.notes | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.8462-4.odds_ratio | primary | available | 261.6060606060606 | — |
| hypertension.statistics.prevalence.observations.8462-4.odds_ratio_ci_lower | primary | available | 70.6843459228985 | — |
| hypertension.statistics.prevalence.observations.8462-4.odds_ratio_ci_upper | primary | available | 968.2162302311294 | — |
| hypertension.statistics.prevalence.observations.8462-4.p_value | primary | available | 3.057369494823142e-34 | — |
| hypertension.statistics.prevalence.observations.8462-4.psynthea_events | primary | available | 97 | — |
| hypertension.statistics.prevalence.observations.8462-4.psynthea_prevalence | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.8462-4.psynthea_total | primary | available | 100 | — |
| hypertension.statistics.prevalence.observations.8462-4.relative_difference | primary | available | 7.818181818181818 | — |
| hypertension.statistics.prevalence.observations.8462-4.risk_ratio | primary | available | 8.818181818181818 | — |
| hypertension.statistics.prevalence.observations.8462-4.risk_ratio_ci_lower | primary | available | 5.04424894012989 | — |
| hypertension.statistics.prevalence.observations.8462-4.risk_ratio_ci_upper | primary | available | 15.4156409609138 | — |
...
| hypertension.statistics.prevalence.observations.8462-4.statistic | primary | available | 12.20134360754206 | — |
...
| … 1 more | — | — | — | — |
### Prevalence endpoint 'observations.8480-6': fail

| Field | Value |
| --- | --- |
| Finding ID | STAT.PREVALENCE.observations.8480-6.FAIL |
| Rule | STAT.PREVALENCE |
| Status | FAIL |
| Severity | high |
| Confidence | high |
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.prevalence.observations.8480-6.absolute_difference | primary | available | 0.86 | — |
| hypertension.statistics.prevalence.observations.8480-6.adjusted_p_value | primary | available | 4.586054242234715e-34 | — |
| hypertension.statistics.prevalence.observations.8480-6.notes | primary | not_computed | — | — |
| hypertension.statistics.prevalence.observations.8480-6.odds_ratio | primary | available | 261.6060606060606 | — |
| hypertension.statistics.prevalence.observations.8480-6.odds_ratio_ci_lower | primary | available | 70.6843459228985 | — |
| hypertension.statistics.prevalence.observations.8480-6.odds_ratio_ci_upper | primary | available | 968.2162302311294 | — |
| hypertension.statistics.prevalence.observations.8480-6.p_value | primary | available | 3.057369494823142e-34 | — |
| hypertension.statistics.prevalence.observations.8480-6.psynthea_events | primary | available | 97 | — |
| hypertension.statistics.prevalence.observations.8480-6.psynthea_prevalence | primary | available | 0.97 | — |
| hypertension.statistics.prevalence.observations.8480-6.psynthea_total | primary | available | 100 | — |
| hypertension.statistics.prevalence.observations.8480-6.relative_difference | primary | available | 7.818181818181818 | — |
| hypertension.statistics.prevalence.observations.8480-6.risk_ratio | primary | available | 8.818181818181818 | — |
| hypertension.statistics.prevalence.observations.8480-6.risk_ratio_ci_lower | primary | available | 5.04424894012989 | — |
| hypertension.statistics.prevalence.observations.8480-6.risk_ratio_ci_upper | primary | available | 15.4156409609138 | — |
...
| hypertension.statistics.prevalence.observations.8480-6.statistic | primary | available | 12.20134360754206 | — |
...
**Observation.** Synthea produced 29 signal(s) and psynthea produced 48, but no expected_terms value was configured.
...
| hypertension.functional.clinical_signal.conditions.psynthea_signal_count | primary | available | 48 | — |
...
**Observation.** Synthea produced 3227 signal(s) and psynthea produced 3465, but no expected_terms value was configured.
...
| hypertension.functional.clinical_signal.observations.psynthea_only_code_count | primary | available | 3 | — |
| hypertension.functional.clinical_signal.observations.psynthea_signal_count | primary | available | 3465 | — |
| hypertension.functional.clinical_signal.observations.shared_code_count | primary | available | 2 | — |
| hypertension.functional.clinical_signal.observations.synthea_only_code_count | primary | available | 3 | — |
| hypertension.functional.clinical_signal.observations.synthea_signal_count | primary | available | 3227 | — |
...
**Observation.** Synthea count=29, psynthea count=48, retention=1.655.
...
#### Clinical event retention for 'observations' is pass

| Field | Value |
| --- | --- |
| Finding ID | CLINICAL.EVENT_RETENTION.observations.PASS |
| Rule | CLINICAL.EVENT_RETENTION |
| Status | PASS |
| Severity | info |
| Confidence | very_high |
...
**Observation.** Synthea count=3227, psynthea count=3465, retention=1.074.

**Interpretation.** psynthea event volume lies inside the configured two-sided clinical-retention interval.

**Impact.** No material event-volume loss is identified by this policy threshold.
...
| hypertension.functional.distributional_similarity.conditions.psynthea_total | primary | available | 48 | — |
...
**Observation.** Evaluated 12 prevalence comparison(s): 3 material, 0 statistically significant but within tolerance, and 9 incomplete or inconsistent.
...
| hypertension.statistics.prevalence.medications.308136.adjusted_p_value | primary | available | 0.0003850744027765 | — |
...
| hypertension.statistics.prevalence.medications.310798.adjusted_p_value | primary | available | 3.650574785680648e-05 | — |
...
| hypertension.statistics.prevalence.medications.314076.adjusted_p_value | primary | available | 3.237956630634452e-06 | — |
...
| hypertension.statistics.prevalence.observations.DALY.adjusted_p_value | primary | available | 8.353950335049822e-45 | — |
...
| hypertension.statistics.prevalence.observations.QALY.adjusted_p_value | primary | available | 8.353950335049822e-45 | — |
...
| hypertension.statistics.prevalence.observations.QOLS.adjusted_p_value | primary | available | 8.353950335049822e-45 | — |
...
| hypertension.statistics.summary.hypertension.mean_jensen_shannon_divergence | primary | available | 0.0951572836602297 | — |
| hypertension.statistics.summary.hypertension.prevalence_test_count | primary | available | 12 | — |
| hypertension.statistics.summary.hypertension.significant_after_fdr_count | primary | available | 12 | — |
| hypertension.statistics.summary.hypertension.significant_test_count | primary | available | 24 | — |
...
**Observation.** statistical test: p=0.0539021, effect_size=0.19 (very small), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.conditions_per_patient.kolmogorov_smirnov.effect_size | primary | available | 0.1899999999999999 | — |
...
| hypertension.statistics.continuous.conditions_per_patient.kolmogorov_smirnov.p_value | primary | available | 0.0539020789312987 | — |
| hypertension.statistics.continuous.conditions_per_patient.kolmogorov_smirnov.significant | primary | available | False | — |
| hypertension.statistics.continuous.conditions_per_patient.kolmogorov_smirnov.statistic | primary | available | 0.1899999999999999 | — |
...
**Observation.** statistical test: p=0.00591121, effect_size=0.19 (very small), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.conditions_per_patient.mann_whitney_u.effect_size | primary | available | 0.1899999999999999 | — |
...
| hypertension.statistics.continuous.conditions_per_patient.mann_whitney_u.p_value | primary | available | 0.0059112094068289 | — |
| hypertension.statistics.continuous.conditions_per_patient.mann_whitney_u.significant | primary | available | True | — |
| hypertension.statistics.continuous.conditions_per_patient.mann_whitney_u.statistic | primary | available | 4050.0 | — |
...
**Observation.** statistical test: p=0.00560296, effect_size=0.396134 (small), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.conditions_per_patient.welch_t_test.effect_size | primary | available | 0.3961338961339976 | — |
...
| hypertension.statistics.continuous.conditions_per_patient.welch_t_test.p_value | primary | available | 0.0056029630004102 | — |
| hypertension.statistics.continuous.conditions_per_patient.welch_t_test.significant | primary | available | True | — |
| hypertension.statistics.continuous.conditions_per_patient.welch_t_test.statistic | primary | available | 2.801089642141972 | — |
...
**Observation.** statistical test: p=1.00246e-11, effect_size=0.5 (moderate), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.encounters_per_patient.kolmogorov_smirnov.effect_size | primary | available | 0.5 | — |
...
| hypertension.statistics.continuous.encounters_per_patient.kolmogorov_smirnov.p_value | primary | available | 1.0024645454361508e-11 | — |
| hypertension.statistics.continuous.encounters_per_patient.kolmogorov_smirnov.significant | primary | available | True | — |
| hypertension.statistics.continuous.encounters_per_patient.kolmogorov_smirnov.statistic | primary | available | 0.5 | — |
...
**Observation.** statistical test: p=1.09436e-07, effect_size=-0.432 (small), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.encounters_per_patient.mann_whitney_u.effect_size | primary | available | -0.4319999999999999 | — |
...
| hypertension.statistics.continuous.encounters_per_patient.mann_whitney_u.p_value | primary | available | 1.094360994109613e-07 | — |
| hypertension.statistics.continuous.encounters_per_patient.mann_whitney_u.significant | primary | available | True | — |
| hypertension.statistics.continuous.encounters_per_patient.mann_whitney_u.statistic | primary | available | 7160.0 | — |
...
**Observation.** statistical test: p=1.35371e-07, effect_size=-0.773963 (moderate), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.encounters_per_patient.welch_t_test.effect_size | primary | available | -0.7739628849098112 | — |
...
| hypertension.statistics.continuous.encounters_per_patient.welch_t_test.p_value | primary | available | 1.353714288868931e-07 | — |
| hypertension.statistics.continuous.encounters_per_patient.welch_t_test.significant | primary | available | True | — |
| hypertension.statistics.continuous.encounters_per_patient.welch_t_test.statistic | primary | available | -5.472744043064309 | — |
...
**Observation.** statistical test: p=2.94843e-11, effect_size=0.49 (small), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.observations_per_patient.kolmogorov_smirnov.effect_size | primary | available | 0.49 | — |
...
| hypertension.statistics.continuous.observations_per_patient.kolmogorov_smirnov.p_value | primary | available | 2.948425133635738e-11 | — |
| hypertension.statistics.continuous.observations_per_patient.kolmogorov_smirnov.significant | primary | available | True | — |
| hypertension.statistics.continuous.observations_per_patient.kolmogorov_smirnov.statistic | primary | available | 0.49 | — |

#### Continuous endpoint 'observations_per_patient.mann_whitney_u': warning

| Field | Value |
| --- | --- |
| Finding ID | STAT.TEST_FAMILIES.continuous.observations_per_patient.mann_whitney_u.WARNING |
| Rule | STAT.TEST_FAMILIES |
| Status | WARNING |
| Severity | low |
| Confidence | high |
...
**Observation.** statistical test: p=0.036473, effect_size=0.1686 (very small), n_synthea=100, n_psynthea=100.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.observations_per_patient.mann_whitney_u.effect_size | primary | available | 0.1685999999999999 | — |
...
| hypertension.statistics.continuous.observations_per_patient.mann_whitney_u.p_value | primary | available | 0.0364730367221426 | — |
| hypertension.statistics.continuous.observations_per_patient.mann_whitney_u.significant | primary | available | True | — |
| hypertension.statistics.continuous.observations_per_patient.mann_whitney_u.statistic | primary | available | 4157.0 | — |

#### Continuous endpoint 'observations_per_patient.welch_t_test': warning

| Field | Value |
| --- | --- |
| Finding ID | STAT.TEST_FAMILIES.continuous.observations_per_patient.welch_t_test.WARNING |
| Rule | STAT.TEST_FAMILIES |
| Status | WARNING |
| Severity | low |
| Confidence | high |
...
**Observation.** statistical test: p=0.115054, effect_size=0.224755 (small), n_synthea=100, n_psynthea=100.

**Interpretation.** The effect estimate is practically relevant although the null-hypothesis test is not significant.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.continuous.observations_per_patient.welch_t_test.effect_size | primary | available | 0.2247548147348471 | — |
...
| hypertension.statistics.continuous.observations_per_patient.welch_t_test.p_value | primary | available | 0.1150537182744871 | — |
| hypertension.statistics.continuous.observations_per_patient.welch_t_test.significant | primary | available | False | — |
| hypertension.statistics.continuous.observations_per_patient.welch_t_test.statistic | primary | available | 1.589256536033366 | — |
...
**Observation.** statistical test: p=3.49732e-34, effect_size=0.311837 (small), n_synthea=939, n_psynthea=693.
...
| Metric | Role | Availability | Value | Rationale |
| --- | --- | --- | --- | --- |
| hypertension.statistics.categorical.encounter_class.chi_square.effect_size | primary | available | 0.3118372496991776 | — |
| hypertension.statistics.categorical.encounter_class.chi_square.n_psynthea | primary | available | 693 | — |
| hypertension.statistics.categorical.encounter_class.chi_square.n_synthea | primary | available | 939 | — |
| hypertension.statistics.categorical.encounter_class.chi_square.notes | primary | not_computed | — | — |
| hypertension.statistics.categorical.encounter_class.chi_square.p_value | primary | available | 3.497315430665815e-34 | — |
| hypertension.statistics.categorical.encounter_class.chi_square.significant | primary | available | True | — |
| hypertension.statistics.categorical.encounter_class.chi_square.statistic | primary | available | 158.69971152951393 | — |
...
**Observation.** Detected 84 evidence value(s) with availability 'not_computed'.
...
| hypertension.functional.table_status.conditions.psynthea_rows | primary | available | 48 | — |
| hypertension.functional.table_status.conditions.relative_row_difference | primary | available | 0.6551724137931034 | — |
| hypertension.functional.table_status.conditions.required | primary | available | True | — |
| hypertension.functional.table_status.conditions.row_difference | primary | available | 19 | — |
...
| hypertension.functional.table_status.encounters.psynthea_rows | primary | available | 693 | — |
| hypertension.functional.table_status.encounters.relative_row_difference | primary | available | -0.2619808306709265 | — |
| hypertension.functional.table_status.encounters.required | primary | available | True | — |
| hypertension.functional.table_status.encounters.row_difference | primary | available | -246 | — |
...
| hypertension.functional.table_status.encounters.synthea_rows | primary | available | 939 | — |
...
| urgent | CLINICAL.CODE_OVERLAP.observations.REVIEW_CODES | CLINICAL.CODE_OVERLAP.observations.FAIL | Review Synthea-only and psynthea-only 'observations' codes and their frequencies. | yes | Recompute code-level similarity after correcting mappings or generation behavior. |
...
| high | STAT.DISTRIBUTION.observations.chi_square.INSPECT | STAT.DISTRIBUTION.observations.chi_square.FAIL | Inspect ECDF/histogram plots and repeat the distribution comparison across seeds. | yes | Confirm both hypothesis-test and JSD/effect criteria after regeneration. |
...
| high | STAT.PREVALENCE.observations.29463-7.REVIEW | STAT.PREVALENCE.observations.29463-7.FAIL | Review disease-module incidence logic, cohort denominators and code mapping for this endpoint. | yes | Repeat across seeds and confirm absolute, relative and ratio criteria using FDR-adjusted inference. |
| high | STAT.PREVALENCE.observations.39156-5.REVIEW | STAT.PREVALENCE.observations.39156-5.FAIL | Review disease-module incidence logic, cohort denominators and code mapping for this endpoint. | yes | Repeat across seeds and confirm absolute, relative and ratio criteria using FDR-adjusted inference. |
| high | STAT.PREVALENCE.observations.8302-2.REVIEW | STAT.PREVALENCE.observations.8302-2.FAIL | Review disease-module incidence logic, cohort denominators and code mapping for this endpoint. | yes | Repeat across seeds and confirm absolute, relative and ratio criteria using FDR-adjusted inference. |
| high | STAT.PREVALENCE.observations.8462-4.REVIEW | STAT.PREVALENCE.observations.8462-4.FAIL | Review disease-module incidence logic, cohort denominators and code mapping for this endpoint. | yes | Repeat across seeds and confirm absolute, relative and ratio criteria using FDR-adjusted inference. |
| high | STAT.PREVALENCE.observations.8480-6.REVIEW | STAT.PREVALENCE.observations.8480-6.FAIL | Review disease-module incidence logic, cohort denominators and code mapping for this endpoint. | yes | Repeat across seeds and confirm absolute, relative and ratio criteria using FDR-adjusted inference. |
...
| medium | STAT.TEST_FAMILIES.continuous.observations_per_patient.mann_whitney_u.INVESTIGATE | STAT.TEST_FAMILIES.continuous.observations_per_patient.mann_whitney_u.WARNING | Inspect the endpoint definition, cohort construction and random-seed sensitivity. | no | Repeat the comparison across independent seeds and report effect estimates with uncertainty. |
| medium | STAT.TEST_FAMILIES.continuous.observations_per_patient.welch_t_test.INVESTIGATE | STAT.TEST_FAMILIES.continuous.observations_per_patient.welch_t_test.WARNING | Inspect the endpoint definition, cohort construction and random-seed sensitivity. | no | Repeat the comparison across independent seeds and report effect estimates with uncertainty. |
...
| Field | Value |
| --- | --- |
| Report ID | hypertension-equivalence.run-20260721T092027177505Z-f18f861d8f8d.hypertension.interpretation |
| Pipeline run | run-20260721T092027177505Z-f18f861d8f8d |
| Report schema | 1.1.0 |
| Generated at | 2026-07-21T09:20:37.606700+00:00 |
| Execution started | 2026-07-21T09:20:37.600137+00:00 |
| Execution completed | 2026-07-21T09:20:37.606700+00:00 |
| Execution duration (s) | 0.006563 |
...
| Document fingerprint | 41ccc3e660c73aaa83ea8354b7de8e3814b9deb8d493826f7ae7563ca194ab99 |

### Rule Evaluations

| Rule | Dimension | Status | Duration (s) | Findings | Derived evidence |
| --- | --- | --- | --- | --- | --- |
| STRUCT.EVIDENCE_INTEGRITY | structural | completed | 0.000233 | 1 | 0 |
| STRUCT.REQUIRED_TABLES | structural | completed | 0.000291 | 5 | 0 |
| STRUCT.COMPARABILITY | structural | completed | 0.000089 | 1 | 0 |
| STAT.READINESS | statistical | completed | 0.000100 | 1 | 0 |
| STAT.TEST_FAMILIES | statistical | completed | 0.000917 | 20 | 0 |
| STAT.PREVALENCE | statistical | completed | 0.001078 | 12 | 0 |
| STAT.DISTRIBUTION | statistical | completed | 0.000234 | 4 | 0 |
| CLINICAL.SIGNAL_PRESERVATION | clinical | completed | 0.000247 | 4 | 0 |
| CLINICAL.EVENT_RETENTION | clinical | completed | 0.000252 | 4 | 0 |
| CLINICAL.CODE_OVERLAP | clinical | completed | 0.000293 | 4 | 0 |
| EPI.DEMOGRAPHIC_PROFILE | epidemiological | completed | 0.000779 | 1 | 0 |
| EPI.PREVALENCE_PROFILE | epidemiological | completed | 0.000840 | 1 | 0 |
| EPI.RELATIONSHIP_PRESERVATION | epidemiological | not_evaluated | 0.000650 | 0 | 0 |
| SPANISH.EVIDENCE_INTEGRITY | spanish_adaptation | not_evaluated | 0.000004 | 0 | 0 |
| SPANISH.PRIMARY_CARE | spanish_adaptation | not_evaluated | 0.000003 | 0 | 0 |
| SPANISH.REFERRALS | spanish_adaptation | not_evaluated | 0.000003 | 0 | 0 |
| SPANISH.HEALTHCARE_FLOW | spanish_adaptation | not_evaluated | 0.000002 | 0 | 0 |
| SPANISH.CLINICAL_CONTEXT | spanish_adaptation | not_evaluated | 0.000003 | 0 | 0 |

### Report Metadata

```json
{
  "pipeline_run_id": "run-20260721T092027177505Z-f18f861d8f8d",
  "recommendation_plan_fingerprint": "39599736c09f001d1dc399ba60282f082e92ea18441472df5669fd89be0bfb33",
  "source_report_id": "hypertension-equivalence.run-20260721T092027177505Z-f18f861d8f8d.hypertension.interpretation",
